...
## There are 3 machines(vagrant vms): ansible(192.0.2.103), ansible-client1(192.0.2.104) and ansible-client2(192.0.2.105),  make sure ansible (192.0.2.103) can ssh to two clients without password:
```
ssh vagrant@192.0.2.104
ssh vagrant@192.0.2.105
ansible -i hosts -m ping all
``` 

## After ansible installed on ansible server, naviage to the directory, test whether ansible playbook works by running:
```
ansible -i hosts roles/test.yml
```
